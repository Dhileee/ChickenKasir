...
class CartAdapter(
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        val tvNama: TextView = view.findViewById(R.id.tvNamaCart)
        val tvHarga: TextView = view.findViewById(R.id.tvHargaCart)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.tvNama.text = item.menu.nama
        holder.tvHarga.text = "Rp ${String.format("%,d", item.menu.harga)}"
